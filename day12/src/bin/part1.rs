...
use day12::{
    generate_constraints, generate_working_spring_sections, parse_input_line, read_input,
    string_is_valid,
};
...
pub fn main() -> Result<()> {
    ...
    for line in parsed_input.iter() {
        let damaged_spring_list = line.1.clone();
        ...
        let (spring_list_length, constraints) = generate_constraints(line.0);
